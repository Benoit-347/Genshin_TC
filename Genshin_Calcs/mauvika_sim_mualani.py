...
#Mav E, Furina EQ, kaz EQ, Xil EQ, = 10s
    ...
    for i in list_seconds:
        ...
        if i == "na":
            ...
            damage =  calc_mauvika(total_atk, buff_dmg_+ 0.15 + 0.30, cr, cd, q_skill, 0, buff_em, buff_res_shred)
        elif i == "evap":
            damage = calc_mauvika(total_atk, buff_dmg_, cr, cd, e_skill, elemental_multiplier, buff_em, buff_res_shred)
        elif i == "ca1vap":
            damage =  calc_mauvika(total_atk, buff_dmg_+ 0.15 + 0.30, cr, cd, ca_skill1, elemental_multiplier, buff_em, buff_res_shred)
        elif i == "ca2vap":
            damage =  calc_mauvika(total_atk, buff_dmg_+ 0.15 + 0.30, cr, cd, ca_skill2, elemental_multiplier, buff_em, buff_res_shred)
        elif i == "qvap":
            damage =  calc_mauvika(total_atk, buff_dmg_+ 0.15 + 0.30, cr, cd, q_skill, elemental_multiplier, buff_em, buff_res_shred)
        else:
